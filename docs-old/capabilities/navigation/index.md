...
|----------|-------------|-----------|------|
| **Live mapping** | Explore a new space where the map updates every frame | `unitree-go2` | [Navigation deep dive](/docs-old/capabilities/navigation/deep_dive.md) |
| **Premap + relocalization** | Return to a known space and plan on a loop-closed map | `unitree-go2-relocalization` | [Relocalization](/docs-old/capabilities/navigation/relocalization.md) |
...
For hardware setup, simulation, and the full blueprint list, see the [Go2 platform guide](/docs-old/platforms/quadruped/go2/index.md).
