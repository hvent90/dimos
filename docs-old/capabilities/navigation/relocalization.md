...
The `unitree-go2-relocalization` blueprint is the standard [Go2 navigation stack](/docs-old/capabilities/navigation/deep_dive.md) plus `RelocalizationModule`:
...
For hardware setup, simulation, and the full blueprint list, see the [Go2 platform guide](/docs-old/platforms/quadruped/go2/index.md). The [v0.0.13 release notes](https://github.com/dimensionalOS/dimos/releases/tag/v0.0.13) summarize the PGO, `dimos map`, and relocalization work this guide builds on.
