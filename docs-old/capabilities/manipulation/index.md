...
For a simulation walkthrough, see [Agentic xArm simulation](/docs-old/capabilities/manipulation/agentic.md).
...
|-------|-----|--------|----------|------------|
| [A-750](/docs-old/capabilities/manipulation/a750.md) | 6 | Y | Y | — |
| Piper | 6 | Y | Y | — |
| XArm6 | 6 | Y | Y | — |
| XArm7 | 7 | Y | Y | Y |
...
[guide is here](/docs-old/capabilities/manipulation/adding_a_custom_arm.md)
