...
It also exposes an agentic [skill](/docs-old/usage/blueprints.md#defining-skills) called `take_a_picture` (more on skills in the Blueprints guide).
...
To see more information on how to use Blueprints, see [Blueprints](/docs-old/usage/blueprints.md).
