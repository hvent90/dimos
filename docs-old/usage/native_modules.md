...
Prerequisite for this is to understand dimos [Modules](/docs-old/usage/modules.md) and [Blueprints](/docs-old/usage/blueprints.md).
...
On how to speak LCM with the rest of dimos, you can read our [LCM intro](/docs-old/usage/lcm.md)
