...
Recordings are stored in the `data/` directory. See [Data Loading](/docs-old/development/large_file_management.md) for how data storage works, including Git LFS handling for large datasets.
