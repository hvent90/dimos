...
> **Prerequisite:** Read [ReactiveX Fundamentals](/docs-old/usage/sensor_streams/reactivex.md) first for Observable basics.
...
If you are doing this periodically as a part of a processing loop, it is very likely that your code will be much cleaner and safer using actual reactivex pipeline. So bias towards checking our [reactivex quick guide](/docs-old/usage/sensor_streams/reactivex.md) and [official docs](https://rxpy.readthedocs.io/)
