...
our LCM implementation significantly [outperforms ROS for local communication](/docs-old/usage/transports/index.md#benchmarks)
...
Given LCM is so portable, we can easily run dimos [Modules](/docs-old/usage/modules.md) written in [third party languages](/docs-old/usage/native_modules.md)
