...
more information on this tool is in [codeblocks](/docs-old/coding-agents/docs/codeblocks.md)
...
```markdown
See [Configuration](/docs-old/usage/configuration.md) for more details.
```
...
More information on this in [doclinks](/docs-old/coding-agents/docs/doclinks.md)
