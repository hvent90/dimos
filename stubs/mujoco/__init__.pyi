...
class MjSpec:
    ...
    def attach(self, child: MjSpec, prefix: str = ..., frame: Any = ...) -> Any: ...
...
def mj_kinematics(model: MjModel, data: MjData) -> None: ...
def mj_comPos(model: MjModel, data: MjData) -> None: ...
def mj_collision(model: MjModel, data: MjData) -> None: ...
def mj_copyData(dest: MjData | None, model: MjModel, src: MjData) -> MjData: ...
def mj_jac(
    model: MjModel,
    data: MjData,
    jacp: NDArray[np.float64] | None,
    jacr: NDArray[np.float64] | None,
    point: NDArray[np.float64],
    body: int,
) -> None: ...
def mj_saveModel(model: MjModel, filename: str | None, buffer: Any | None = ...) -> None: ...
def mju_mat2Quat(quat: NDArray[np.float64], mat: NDArray[np.float64]) -> None: ...
