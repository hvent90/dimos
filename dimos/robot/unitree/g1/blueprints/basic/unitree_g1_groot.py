...
from dimos.robot.unitree.g1.blueprints.primitive.unitree_g1_groot_wbc import unitree_g1_groot_wbc
...
unitree_g1_groot = autoconnect(unitree_g1_groot_wbc, *_nav_modules).global_config(n_workers=12)
