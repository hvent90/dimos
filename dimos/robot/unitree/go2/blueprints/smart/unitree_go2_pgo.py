...
"""unitree_go2_pgo: run the jnav PGO live on a Go2's Livox Mid-360 + Point-LIO
and visualize the optimized pose graph in Rerun.
...
(whose own `lidar` Out would collide with Point-LIO's registered `lidar`).
