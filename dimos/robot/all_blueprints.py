...
all_blueprints = {
    ...
    "unitree-go2-agentic-memory": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_agentic_memory:unitree_go2_agentic_memory",
...
all_modules = {
    ...
    "memory-query-skill": "dimos.agents.skills.memory_query.MemoryQuerySkill",
