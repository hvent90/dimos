...
all_blueprints = {
    ...
    "unitree-go2-nav": "dimos.robot.unitree.go2.blueprints.navigation.unitree_go2_nav:unitree_go2_nav",
...
all_modules = {
    ...
    "apply-closure": "dimos.navigation.nav_stack.modules.apply_closure.apply_closure.ApplyClosure",
    ...
    "kitti360-playback-module": "dimos.navigation.nav_stack.benchmarks.pose_graph_kitti360.playback.Kitti360PlaybackModule",
    ...
    "pose-graph-scoring-module": "dimos.navigation.nav_stack.benchmarks.pose_graph_kitti360.scoring.PoseGraphScoringModule",
    ...
    "topic-counter-module": "dimos.navigation.nav_stack.modules.pgo.benchmark_kitti360_smoke.TopicCounterModule",
