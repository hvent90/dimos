...
all_blueprints = {
    ...
    "agibot-x2-basic-babylon": "dimos.robot.agibot.x2_ultra.blueprints.basic.agibot_x2_basic_babylon:agibot_x2_basic_babylon",
    "agibot-x2-basic-rerun": "dimos.robot.agibot.x2_ultra.blueprints.basic.agibot_x2_basic_rerun:agibot_x2_basic_rerun",
    ...
    "unitree-g1-dds-coordinator": "dimos.robot.unitree.g1.blueprints.basic.unitree_g1_dds_coordinator:unitree_g1_dds_coordinator",
    ...
    "unitree-g1-lowlevel": "dimos.robot.unitree.g1.blueprints.basic.unitree_g1_lowlevel:unitree_g1_lowlevel",
    ...
    "unitree-g1-playback": "dimos.robot.unitree.g1.blueprints.basic.unitree_g1_playback:unitree_g1_playback",
    ...
    "unitree-g1-webrtc-coordinator": "dimos.robot.unitree.g1.blueprints.basic.unitree_g1_webrtc_coordinator:unitree_g1_webrtc_coordinator",
...
all_modules = {
    ...
    "babylon-scene-viewer-module": "dimos.experimental.pimsim.module.BabylonSceneViewerModule",
    ...
    "g1-arm-teleop": "dimos.robot.unitree.g1.arm_teleop.G1ArmTeleop",
    ...
    "g1-low-level-control": "dimos.control.examples.g1_zero_posture.G1LowLevelControl",
    "g1-manipulation-module": "dimos.robot.unitree.g1.g1_manipulation.G1ManipulationModule",
    "g1-memory": "dimos.robot.unitree.g1.blueprints.basic.unitree_g1_groot_wbc_sim.G1Memory",
    "g1-playback": "dimos.control.examples.g1_playback.G1Playback",
    "g1-quest-teleop-module": "dimos.robot.unitree.g1.quest_teleop.G1QuestTeleopModule",
    "g1-sim-connection": "dimos.robot.unitree.g1.mujoco_sim.G1SimConnection",
    "g1-sim-locomotion": "dimos.agents.skills.sim_g1_locomotion.G1SimLocomotion",
    ...
    "mesh-camera-module": "dimos.mapping.mesh_camera.MeshCameraModule",
    ...
    "object-finder3-d": "dimos.memory2.finder.ObjectFinder3D",
