...
all_blueprints = {
    ...
    "dual-xarm6-planner-coordinator": "dimos.manipulation.blueprints:dual_xarm6_planner_coordinator",
    "dual-xarm7-planner-coordinator": "dimos.manipulation.blueprints:dual_xarm7_planner_coordinator",
