...
all_blueprints = {
    ...
    "coordinator-openarm-rs": "dimos.robot.manipulators.openarm.blueprints.basic:coordinator_openarm_rs",
    ...
    "gpd-mujoco-grasp-demo": "dimos.robot.manipulators.xarm.blueprints.simulation:gpd_mujoco_grasp_demo",
    ...
    "openarm-rs-planner-coordinator": "dimos.robot.manipulators.openarm.blueprints.planner:openarm_rs_planner_coordinator",
    ...
    "vgn-mujoco-grasp-demo": "dimos.robot.manipulators.xarm.blueprints.simulation:vgn_mujoco_grasp_demo",
...
all_modules = {
    ...
    "open-arm-joint-state-viser-module": "dimos.teleop.openarm_mini.viser_visualizer.OpenArmJointStateViserModule",
    "open-arm-mini-teleop-module": "dimos.teleop.openarm_mini.teleop_module.OpenArmMiniTeleopModule",
    ...
    "pointcloud-grasp-demo-controller": "dimos.manipulation.grasping.pointcloud_grasp_demo_controller.PointcloudGraspDemoController",
    ...
    "scene-reconstruction-module": "dimos.perception.reconstruction.scene_reconstruction.SceneReconstructionModule",
    ...
    "target-grasp-demo-controller": "dimos.manipulation.grasping.target_grasp_demo_controller.TargetGraspDemoController",
    "teleop-module": "dimos.teleop.runtime.teleop_module.TeleopModule",
    ...
    "vgn-grasp-gen-module": "dimos.manipulation.grasping.vgn_grasp_gen_module.VGNGraspGenModule",
