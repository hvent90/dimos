...
all_blueprints = {
    ...
    "learning-collect-quest-dual": "dimos.learning.collection.blueprint:learning_collect_quest_dual",
    "learning-collect-quest-piper": "dimos.learning.collection.blueprint:learning_collect_quest_piper",
    "learning-collect-quest-xarm6": "dimos.learning.collection.blueprint:learning_collect_quest_xarm6",
    ...
    "go2-tripod-real": "dimos.robot.unitree.go2.blueprints.rl.go2_tripod_real:go2_tripod_real",
    "go2-tripod-sim": "dimos.robot.unitree.go2.blueprints.rl.go2_tripod_sim:go2_tripod_sim",
...
all_modules = {
    ...
    "chunk-policy-module": "dimos.learning.inference.chunk_policy_module.ChunkPolicyModule",
    ...
    "data-prep-module": "dimos.learning.dataprep_module.DataPrepModule",
    ...
    "go2-whole-body-connection": "dimos.robot.unitree.go2.wholebody_connection.Go2WholeBodyConnection",
    ...
    "trainer-module": "dimos.learning.training.trainer_module.TrainerModule",
