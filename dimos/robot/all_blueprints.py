...
all_blueprints = {
    ...
    "unitree-go2-map-nav": "dimos.robot.unitree.go2.blueprints.navigation.unitree_go2_map_nav:unitree_go2_map_nav",
...
all_modules = {
    ...
    "map-nav-agent": "dimos.navigation.map_nav.map_nav_agent.MapNavAgent",
    "map-nav-plant": "dimos.navigation.map_nav.map_nav_plant.MapNavPlant",
