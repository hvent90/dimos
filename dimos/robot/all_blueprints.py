...
all_blueprints = {
    ...
    "unitree-go2-mid360-pgo": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_mid360_pgo:unitree_go2_mid360_pgo",
...
all_modules = {
    ...
    "graph-capture": "dimos.navigation.jnav.components.loop_closure.eval.GraphCapture",
    ...
    "lockstep-replay": "dimos.navigation.jnav.components.loop_closure.eval.LockstepReplay",
    ...
    "pgo": "dimos.navigation.jnav.components.loop_closure.gsc_pgo.module.PGO",
    ...
    "rate-replay": "dimos.navigation.jnav.components.loop_closure.eval.RateReplay",
    ...
    "sensor-frame-lidar-bridge": "dimos.robot.unitree.go2.sensor_frame_lidar_bridge.SensorFrameLidarBridge",
