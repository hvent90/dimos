...
all_blueprints = {
    ...
    "unitree-go2-dannav": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_dannav:unitree_go2_dannav",
...
all_modules = {
    ...
    "dan-holonomic-tc": "dimos.navigation.holonomic_trajectory_controller.module.DanHolonomicTC",
    "dannav-planner": "dimos.navigation.dannav.module.DannavPlanner",
    ...
    "pose-odom-relay": "dimos.navigation.nav_3d.mls_planner.goal_relay.PoseOdomRelay",
