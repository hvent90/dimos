...
all_blueprints = {
    ...
    "rustlio2": "dimos.hardware.sensors.lidar.rustlio2.rustlio2_blueprints:rustlio2",
    "rustlio2-ray-trace": "dimos.hardware.sensors.lidar.rustlio2.rustlio2_blueprints:rustlio2_ray_trace",
    "rustlio2-record": "dimos.hardware.sensors.lidar.rustlio2.rustlio2_blueprints:rustlio2_record",
    "rustlio2-replay": "dimos.hardware.sensors.lidar.rustlio2.rustlio2_blueprints:rustlio2_replay",
    "rustlio2-voxels": "dimos.hardware.sensors.lidar.rustlio2.rustlio2_blueprints:rustlio2_voxels",
    ...
    "unitree-go2-record": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_record:unitree_go2_record",
...
all_modules = {
    ...
    "livox-db-replay": "dimos.hardware.sensors.lidar.rustlio2.rustlio2_replay.LivoxDbReplay",
    ...
    "rustlio2-recorder": "dimos.hardware.sensors.lidar.rustlio2.recorder.Rustlio2Recorder",
    ...
    "speed-warner": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_record.SpeedWarner",
