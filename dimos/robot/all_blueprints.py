...
all_blueprints = {
    ...
    "realsense-mid360-record": "dimos.mapping.recording.mid360_realsense.record:realsense_mid360_record",
    ...
    "unitree-go2-record": "dimos.mapping.recording.go2_mid360.record:unitree_go2_record",
...
all_modules = {
    ...
    "go2-recorder": "dimos.mapping.recording.go2_mid360.record.Go2Recorder",
    ...
    "graph-capture": "dimos.navigation.nav_stack.modules.pgo.lockstep_harness.GraphCapture",
    ...
    "keyboard-teleop-tui": "dimos.robot.unitree.keyboard_teleop_tui.KeyboardTeleopTUI",
    "local-planner": "dimos.navigation.nav_stack.modules.local_planner.local_planner.LocalPlanner",
    "lockstep-replay": "dimos.navigation.nav_stack.modules.pgo.lockstep_harness.LockstepReplay",
    ...
    "pgo": "dimos.navigation.nav_stack.modules.pgo.unrefined_pgo.module.PGO",
    ...
    "rate-replay": "dimos.navigation.nav_stack.modules.pgo.eval.RateReplay",
    ...
    "realsense-recorder": "dimos.mapping.recording.mid360_realsense.record.RealsenseRecorder",
    ...
    "rosbag-scan-odom-playback-module": "dimos.navigation.nav_stack.tests.rosbag_fixtures.RosbagScanOdomPlaybackModule",
    ...
    "synthetic-lockstep-replay": "dimos.navigation.nav_stack.modules.pgo.lockstep_harness.SyntheticLockstepReplay",
