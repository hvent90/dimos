...
all_blueprints = {
    ...
    "coordinator-flowbase-benchmark": "dimos.control.blueprints.mobile:coordinator_flowbase_benchmark",
    ...
    "coordinator-flowbase-nav-tuned": "dimos.control.blueprints.mobile:coordinator_flowbase_nav_tuned",
    "coordinator-flowbase-precision-nav": "dimos.control.blueprints.mobile:coordinator_flowbase_precision_nav",
    ...
    "unitree-go2-benchmark": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_benchmark:unitree_go2_benchmark",
    ...
    "unitree-go2-coordinator-rage": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_coordinator:unitree_go2_coordinator_rage",
    ...
    "unitree-go2-precision-nav": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_precision_nav:unitree_go2_precision_nav",
    "unitree-go2-precision-nav-rage": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_precision_nav:unitree_go2_precision_nav_rage",
...
all_modules = {
    ...
    "characterization-recorder": "dimos.utils.benchmarking.characterization_recorder.CharacterizationRecorder",
    "characterizer": "dimos.utils.benchmarking.characterization.Characterizer",
    ...
    "fopdt-plant-connection": "dimos.robot.sim.fopdt_plant_connection.FopdtPlantConnection",
