...
all_blueprints = {
    ...
    "coordinator-openyam-bare": "dimos.robot.manipulators.openyam.blueprints.basic:coordinator_openyam_bare",
    "coordinator-openyam-gripper": "dimos.robot.manipulators.openyam.blueprints.basic:coordinator_openyam_gripper",
    ...
    "keyboard-teleop-openyam-bare": "dimos.robot.manipulators.openyam.blueprints.teleop:keyboard_teleop_openyam_bare",
    "keyboard-teleop-openyam-gripper": "dimos.robot.manipulators.openyam.blueprints.teleop:keyboard_teleop_openyam_gripper",
    ...
    "openyam-bare-planner-coordinator": "dimos.robot.manipulators.openyam.blueprints.basic:openyam_bare_planner_coordinator",
    "openyam-gripper-planner-coordinator": "dimos.robot.manipulators.openyam.blueprints.basic:openyam_gripper_planner_coordinator",
