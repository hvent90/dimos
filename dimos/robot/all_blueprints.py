...
all_modules = {
    ...
    "go2-tf-hack-recorder": "dimos.mapping.recording.go2_mid360.record.Go2TfHackRecorder",
    ...
    "tf-hack-recorder": "dimos.mapping.recording.mid360_realsense.record.TfHackRecorder",
