...
all_modules = {
    ...
    "odom-tf-broadcaster": "dimos.experimental.pimsim.odometry_adapter.OdomTfBroadcaster",
    ...
    "pose-stamped-to-odometry": "dimos.mapping.ray_tracing.module.PoseStampedToOdometry",
