...
all_blueprints = {
    ...
    "path-planner-eval": "dimos.navigation.nav_stack.evaluator.blueprints:path_planner_eval",
    ...
    "unitree-go2-twitch": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_twitch:unitree_go2_twitch",
...
all_modules = {
    ...
    "straight-line-planner": "dimos.navigation.nav_stack.evaluator.straight_line_planner.StraightLinePlanner",
    ...
    "twitch-chat": "dimos.stream.twitch.module.TwitchChat",
    "twitch-votes": "dimos.stream.twitch.votes.TwitchVotes",
