...
class __XArmDynamics:
    ...
    def gen(cls):
        ...
        for i in range(len(cls.MASS)):
            data[f"link{i + 1}"] = {
                "mass": cls.MASS[i],
                "origin": {"x": cls.ORIGIN[i][0], "y": cls.ORIGIN[i][1], "z": cls.ORIGIN[i][2]},
                "inertia": {
                    "ixx": cls.INERTIA[i][0],
                    "ixy": -cls.INERTIA[i][1],
                    "ixz": -cls.INERTIA[i][2],
        ...
        try:
            ...
            print(f"write {cls.CONFIG_NAME} success")
        except Exception as e:
            print(f"write {cls.CONFIG_NAME} exception, {e}")
