...
def test_trap_last_seen_in_region_is_not_global_last(
    trap_container: SceneGraphSkillContainer,
) -> None:
...
def test_ever_in_region_via_visits(trap_container: SceneGraphSkillContainer) -> None:
...
def test_never_in_uncovered_region_reports_weak_evidence(
    coverage_container: SceneGraphSkillContainer,
) -> None:
...
def test_unknown_in_node_rejected(trap_container: SceneGraphSkillContainer) -> None:
...
def test_object_in_node_rejected(trap_container: SceneGraphSkillContainer) -> None:
...
def test_adjacent_rooms(trap_container: SceneGraphSkillContainer) -> None:
...
def test_agent_last_seen_in_room(agent_container: SceneGraphSkillContainer) -> None:
...
def test_agent_seen_between_window(agent_container: SceneGraphSkillContainer) -> None:
...
def test_where_am_i_resolves_room(agent_container: SceneGraphSkillContainer) -> None:
