...
class SceneMeshAlignment:
    ...
    Inlined here so the runtime loader has no USD / open3d dependency
    (the full mesh_scene.py lives in the cooking pipeline and isn't
    needed on a runtime-only branch).
    """
...
_ENTITY_PATH_KEYS = ("visual_path", "collision_path", "collision_paths", "mesh_path")
