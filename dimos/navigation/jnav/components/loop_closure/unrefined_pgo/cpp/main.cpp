...
int main(int argc, char** argv)
{
    ...
    // rate <= 0 disables global_map entirely (it's a big cloud that can overflow
    // LCM's single-message limit and congest the bus). Consumers that only need
    // corrected_odometry / pose_graph should turn it off.
