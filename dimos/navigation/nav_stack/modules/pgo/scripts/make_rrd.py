...
Standalone: python dimos/navigation/nav_stack/modules/pgo/scripts/make_rrd.py --rec=PATH [--lidar=...] [--odom=...] [--tags=...] [--out=...]
"""
...
if __name__ == "__main__":
    ...
    if not rec_arg:
        sys.exit(
            "usage: python dimos/navigation/nav_stack/modules/pgo/scripts/make_rrd.py --rec=PATH [--lidar=...] [--odom=...] "
