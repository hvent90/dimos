...
Usage: python dimos/navigation/nav_stack/modules/pgo/scripts/detect_tags.py --rec=PATH
...
if not REC_ARG:
    sys.exit(
        "usage: python dimos/navigation/nav_stack/modules/pgo/scripts/detect_tags.py --rec=PATH [--camera=...] [--tag-size=...] "
